...
public final class RiskRules {
    ...
    public static final Map<ContentIndicator, Integer> CONTENT_WEIGHTS = Map.of (
        ...
        ContentIndicator.BRAND_MENTIONED, BRAND_MENTIONED_WEIGHT,
        ContentIndicator.LOGIN_FORM, LOGIN_FORM_WEIGHT,
        ContentIndicator.PASSWORD_FIELD, PASSWORD_FIELD_WEIGHT,
        ContentIndicator.WALLET_KEYWORDS, WALLET_KEYWORDS_WEIGHT,
        ContentIndicator.PAYMENT_KEYWORDS, PAYMENT_KEYWORDS_WEIGHT
    );

/*    public static final Map<EvidenceType, Integer> EVIDENCE_WEIGHTS = Map.of (

        EvidenceType.MX_CONFIGURED, MX_CONFIGURED_WEIGHT,
        EvidenceType.CERTIFICATE_FOUND, CERTIFICATE_FOUND_WEIGHT,
        EvidenceType.RECENT_REGISTRATION, RECENT_REGISTRATION_WEIGHT
    );*/
}