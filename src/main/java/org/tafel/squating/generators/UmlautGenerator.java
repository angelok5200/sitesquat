...
@Component
public class UmlautGenerator implements CandidateGenerator {
    ...
    public List<CandidateDomain> generate(Brand brand) {
        ...
        for (int i = 0; i < name.length(); i++) {
            ...
            char replacement = UmlautFor(original);
            ...
            String unicodeDomain = new String(chars) + tld;
            String candidateDomain = IDN.toASCII(unicodeDomain);
    ...
    private char UmlautFor (char character){
